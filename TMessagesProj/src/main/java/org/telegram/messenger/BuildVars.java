...
public class BuildVars {
    ...
    public static int APP_ID = 25091982;
    public static String APP_HASH = "85bfe13138059e0a8fbbc616dbfc0ffa";
    ...
    public static boolean isBetaApp() {
        if (betaApp == null) {
            betaApp = ApplicationLoader.applicationContext != null && "io.toncorp.tonmessenger.beta".equals(ApplicationLoader.applicationContext.getPackageName());
        }
        return betaApp;
    }
